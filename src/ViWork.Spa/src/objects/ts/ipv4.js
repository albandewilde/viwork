export class ipv4 {
    ...
    static network_addresse(ipa) {
        return ipa == null ? null : ipa.address & ipa.mask;
    }
    static wildcard_addresse(ipa) {
        return ipa != null ? ~ipa.mask : null;
    }
    static broadcast_addresse(ipa) {
    ...
    static toAddress(nombre) {
        return (String((nombre >> 24) & 255) + "." +
