<template>
    <div>
        ...
        <el-col :offset="7">
            <el-button type="primary" style="width: 40%" @click="register('BaseRegister')">S'inscrire via ViWork
            </el-button>
        </el-col>
        <el-col style="padding-top: 15px">
            <el-form ref="form" :model="form" label-width="175px">
            <el-form-item label="Identité :">
                <el-input type="text" placeholder="Nom" v-model="form.LastName" size="medium" style="width: 75%;"></el-input>
                <el-input type="text" placeholder="Prénom" v-model="form.FirstName" size="medium" style="width: 75%;"></el-input>
            </el-form-item>
            ...
            <el-form-item label="Confirmez le mot de passe :">
                <el-input type="password" placeholder="Mot de passe" v-model="form.ConfirmPassword" size="medium" style="width: 75%;"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click="onSubmit()">S'inscrire</el-button>
            </el-form-item>
        </el-form>
        </el-col>
    </div>
